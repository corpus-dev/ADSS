## Автоматичний старт сервера DDoS від Кіберкорпусу (ADSS)
...
Автоматичне встановлення distress, mhddos відповідної архітектури та розрядності для відповідної машини. Для кожної утиліти окрім завантаження, створюється системна служба. Це дозволяє стежити за її станом і у випадку збою чи перезавантаження машини автоматично запустити її знову. 
...
- **Пункти «DISTRESS» та «X100» аналогічні до «MHDDOS»**
