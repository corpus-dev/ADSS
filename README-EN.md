## Automatic DDoS Server Starter from Cyber Corps (ADSS)
...
Ubuntu, Debian, Fedora, Centos, Arch Linux, Kali Linux, Parrot Security OS, Rocky Linux, AlmaLinux OS, Manjaro, Oracle Linux, Void Linux (х86,х64,arm), Gentoo
...
- **The "DISTRESS" and "X100" items are similar to "MHDDOS"**
